...
| relief shares | 회사 응답 중 monetary/non-monetary relief 비율 | 결과·보상 사실의 인과로 해석 금지 |
| product/issue concentration | product·issue별 민원 건수 비중 | 분류체계 버전과 함께 비교 |
| channel/state mix | Submitted via·State 분포 | 신고 채널 접근성 편향 가능 |
| narrative availability | 역사적 공개 서술문 존재 비율 | 비공개/미제출 및 2026-08-14 정책 변경 이후 신규 건은 텍스트 추세 분석 대상 아님 |
| anomaly_count | 최소 건수·rolling robust z 기준 통과 product/issue/month 수 | 탐지 결과는 조사 우선순위 신호 |
